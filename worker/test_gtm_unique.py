"""
Test GTM Workflow with unique topic

Triggers a GTMWorkflow with a unique, time-specific topic.
"""
...
async def main():
    """Trigger a GTM workflow with unique topic"""
    ...
    print("🚀 Testing GTM Workflow (Unique Topic)")
    print("=" * 60)
    ...
    # Define test topic - unique to avoid duplicates
    topic = "AI-powered sales enablement platforms for enterprise SaaS in November 2025"
    ...
    workflow_id = f"gtm-test-unique-{uuid4()}"
