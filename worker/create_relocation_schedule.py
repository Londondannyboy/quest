"""
Create Temporal Schedule for Relocation (Corporate) Daily Workflow

Run this script once to create the daily schedule.
Focuses on UK corporate relocation news (excluding digital nomad content).
"""
...
async def create_schedule():
    """Create the Relocation daily schedule"""
    ...
    print("🔧 Creating Relocation (Corporate) Daily Schedule")
    print("=" * 60)
    ...
    # Define the schedule
    schedule_id = "digital-nomad-uk-daily"

    # Workflow arguments - Focus on corporate relocation, exclude digital nomad
    search_topic = "UK corporate relocation -digital nomad"
    ...
    print(f"   Workflow: RelocationWorkflow")
    ...
    try:
        ...
        await client.create_schedule(
            ...
            schedule=Schedule(
                action=ScheduleActionStartWorkflow(
                    ...
                    id=f"article-relocation-scheduled-{{{{.ScheduledTime.Unix}}}}",
        ...
        print(f"Focus: UK Corporate Relocation (excludes digital nomad)")
        print()
