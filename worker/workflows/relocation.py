"""
Relocation Workflow - Dedicated workflow for relocation.guide

Focused on expat content, visa information, cost of living, cultural guidance.
Hardcoded with relocation-specific image generation prompts.
"""
...
class RelocationWorkflow:
    """
    Dedicated workflow for Relocation guide articles

    This workflow:
    - Searches for relocation/expat news
    - Scrapes and extracts entities
    - Generates practical, helpful articles for relocating professionals
    - Generates travel/lifestyle imagery
    - Saves to database with app='relocation'
    """
    ...
    async def run(
        ...
        """
        Run the relocation workflow

        Args:
            topic: Relocation topic to generate article about
        ...
        """
        app = "relocation"  # Hardcoded for this workflow

        workflow.logger.info(f"🚀 Relocation workflow started")
        ...
        brief = {
            ...
            "angle": themes[0] if themes else "Relocation guide",
        ...
        # Use dedicated relocation image generation activity
        ...
        if image_urls.get('hero'):
            workflow.logger.info(f"✅ Generated 6 relocation images: hero, featured, content, content2, content3, content4")
        else:
        ...
        # =====================================================================
        workflow.logger.info("=" * 60)
        workflow.logger.info("🎉 RELOCATION WORKFLOW COMPLETE")
        workflow.logger.info("=" * 60)
