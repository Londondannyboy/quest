"""
Chief of Staff Workflow - Dedicated workflow for chiefofstaff.quest

Focused on executive management, C-suite operations, organizational leadership.
Hardcoded with chief-of-staff-specific image generation prompts.
"""
...
class ChiefOfStaffWorkflow:
    """
    Dedicated workflow for Chief of Staff executive leadership articles

    This workflow:
    - Searches for executive leadership news
    - Scrapes and extracts entities
    - Generates sophisticated executive-focused articles
    - Generates executive/C-suite imagery with 'Chief of Staff' branding
    - Saves to database with app='chiefofstaff'
    """
    ...
    async def run(
        ...
        """
        Run the chief of staff workflow

        Args:
            topic: Executive leadership topic to generate article about
        ...
        brief = {
            ...
            "angle": themes[0] if themes else "Executive leadership analysis",
        ...
        # Use dedicated chief of staff image generation activity
        ...
        if image_urls.get('hero'):
            workflow.logger.info(f"✅ Generated 6 chief of staff images: hero, featured, content, content2, content3, content4")
        else:
        ...
        # =====================================================================
        workflow.logger.info("=" * 60)
        workflow.logger.info("🎉 CHIEF OF STAFF WORKFLOW COMPLETE")
        workflow.logger.info("=" * 60)
