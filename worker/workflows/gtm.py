"""
GTM Workflow - Dedicated workflow for gtm.quest

Focused on go-to-market strategy, sales enablement, market entry, and product launches.
Hardcoded with GTM-specific image generation prompts.
"""
...
class GTMWorkflow:
    """
    Dedicated workflow for GTM (Go-To-Market) articles

    This workflow:
    - Searches for go-to-market strategy and sales news
    - Scrapes and extracts entities
    - Generates strategic, actionable GTM-focused articles
    - Generates professional imagery with 'GTM' branding
    - Saves to database with app='gtm'
    """
    ...
    async def run(
        ...
        """
        Run the GTM workflow

        Args:
            topic: Go-to-market topic to generate article about
        ...
        """
        app = "gtm"  # Hardcoded for this workflow

        workflow.logger.info(f"🚀 GTM workflow started")
        ...
        brief = {
            ...
            "angle": themes[0] if themes else "Go-to-market strategy analysis",
        ...
        # Use dedicated GTM image generation activity
        ...
        if image_urls.get('hero'):
            workflow.logger.info(f"✅ Generated 6 GTM images: hero, featured, content, content2, content3, content4")
        else:
        ...
        # =====================================================================
        workflow.logger.info("=" * 60)
        workflow.logger.info("🎉 GTM WORKFLOW COMPLETE")
        workflow.logger.info("=" * 60)
