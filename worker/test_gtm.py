...
Triggers a GTMWorkflow to generate a go-to-market strategy article.
"""
...
async def main():
    ...
    # Define test topic
    topic = "Product-led growth strategies for B2B SaaS companies"
