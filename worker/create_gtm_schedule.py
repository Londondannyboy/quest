"""
Create Temporal Schedule for GTM Daily Workflow
...
async def create_schedule():
    ...
    print("🔧 Creating GTM Daily Schedule")
    print("=" * 60)
        ...
        await client.create_schedule(
            ...
            schedule=Schedule(
                action=ScheduleActionStartWorkflow(
                    ...
                    id=f"article-gtm-scheduled-{{{{.ScheduledTime.Unix}}}}",
